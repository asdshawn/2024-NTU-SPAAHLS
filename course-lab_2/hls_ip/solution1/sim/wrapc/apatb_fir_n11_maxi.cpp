...
tr.send<4>((char*)__xlx_apatb_param_pn32HPInput, 128, 0);
tr.send<4>((char*)__xlx_apatb_param_pn32HPOutput, 128, 128);
}
#else
try {
...
if (__xlx_apatb_param_pn32HPInput) {
  tr.import<4>((char*)__xlx_apatb_param_pn32HPInput, 128, 0);
}
__xlx_offset_byte_param_pn32HPOutput = 128*4;
if (__xlx_apatb_param_pn32HPOutput) {
  tr.import<4>((char*)__xlx_apatb_param_pn32HPOutput, 128, 0);
}
