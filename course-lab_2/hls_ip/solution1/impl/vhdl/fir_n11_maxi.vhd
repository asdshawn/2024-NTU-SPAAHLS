...
architecture behav of fir_n11_maxi is 
    ...
    signal lshr_ln15_cast_reg_440 : STD_LOGIC_VECTOR (30 downto 0);
    signal an32Coef_load_10_reg_446 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln17_1_reg_451 : STD_LOGIC_VECTOR (61 downto 0);
    signal trunc_ln29_1_reg_456 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    signal zext_ln15_fu_285_p1 : STD_LOGIC_VECTOR (32 downto 0);
    signal add_ln15_fu_289_p2 : STD_LOGIC_VECTOR (32 downto 0);
...
begin
    ...
    port map (
        ...
        sext_ln29_1 => trunc_ln29_1_reg_456,
        sext_ln17_1 => trunc_ln17_1_reg_451,
        lshr_ln15_cast => lshr_ln15_cast_reg_440,
        pn32HPInput => pn32HPInput_read_reg_435,
        empty => lshr_ln15_cast_reg_440,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
                ...
                lshr_ln15_cast_reg_440 <= add_ln15_fu_289_p2(32 downto 2);
                pn32HPInput_read_reg_435 <= pn32HPInput;
                pn32HPOutput_read_reg_430 <= pn32HPOutput;
                trunc_ln17_1_reg_451 <= pn32HPInput(63 downto 2);
                trunc_ln29_1_reg_456 <= pn32HPOutput(63 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln15_fu_289_p2 <= std_logic_vector(unsigned(zext_ln15_fu_285_p1) + unsigned(ap_const_lv33_3));
    ...
    zext_ln15_fu_285_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(regXferLeng),33));
end behav;
