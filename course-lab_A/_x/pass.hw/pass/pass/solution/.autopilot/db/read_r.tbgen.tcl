...
set C_modelArgList {
	...
	{ numInputs_c9 int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "numInputs_c9", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ inStream2_din sc_out sc_lv 512 signal 2 } 
	{ inStream2_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ inStream2_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ inStream2_full_n sc_in sc_logic 1 signal 2 } 
	{ inStream2_write sc_out sc_logic 1 signal 2 } 
	{ numInputs sc_in sc_lv 32 signal 3 } 
	{ numInputs_c9_din sc_out sc_lv 32 signal 4 } 
	{ numInputs_c9_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ numInputs_c9_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ numInputs_c9_full_n sc_in sc_logic 1 signal 4 } 
	{ numInputs_c9_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "numInputs_c9_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "numInputs_c9", "role": "din" }} , 
 	{ "name": "numInputs_c9_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "numInputs_c9", "role": "num_data_valid" }} , 
 	{ "name": "numInputs_c9_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "numInputs_c9", "role": "fifo_cap" }} , 
 	{ "name": "numInputs_c9_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numInputs_c9", "role": "full_n" }} , 
 	{ "name": "numInputs_c9_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numInputs_c9", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "p0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_Pipeline_VITIS_LOOP_13_1_fu_82", "Port" : "p0", "Inst_start_state" : "72", "Inst_end_state" : "73"}]},
			{"Name" : "input_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "inStream2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_Pipeline_VITIS_LOOP_13_1_fu_82", "Port" : "inStream2", "Inst_start_state" : "72", "Inst_end_state" : "73"}]},
			{"Name" : "numInputs", "Type" : "None", "Direction" : "I"},
			{"Name" : "numInputs_c9", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "numInputs_c9_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_Pipeline_VITIS_LOOP_13_1_fu_82", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_read_Pipeline_VITIS_LOOP_13_1_fu_82.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	numInputs_c9 { ap_fifo {  { numInputs_c9_din fifo_port_we 1 32 }  { numInputs_c9_num_data_valid fifo_status_num_data_valid 0 2 }  { numInputs_c9_fifo_cap fifo_update 0 2 }  { numInputs_c9_full_n fifo_status 0 1 }  { numInputs_c9_write fifo_data 1 1 } } }
}
