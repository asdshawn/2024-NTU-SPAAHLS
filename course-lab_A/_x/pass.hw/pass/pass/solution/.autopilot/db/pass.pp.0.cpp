# 1 "/mnt/HLSNAS/02.IZunsR/course-lab_A/Vitis-Tutorials/Hardware_Acceleration/Design_Tutorials/07-host-code-opt/reference-files/src/pass.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/mnt/HLSNAS/02.IZunsR/course-lab_A/Vitis-Tutorials/Hardware_Acceleration/Design_Tutorials/07-host-code-opt/reference-files/src/pass.cpp" 2
...
# 7 "/mnt/HLSNAS/02.IZunsR/course-lab_A/Vitis-Tutorials/Hardware_Acceleration/Design_Tutorials/07-host-code-opt/reference-files/src/pass.cpp" 2
...
# 8 "/mnt/HLSNAS/02.IZunsR/course-lab_A/Vitis-Tutorials/Hardware_Acceleration/Design_Tutorials/07-host-code-opt/reference-files/src/pass.cpp" 2
...
# 9 "/mnt/HLSNAS/02.IZunsR/course-lab_A/Vitis-Tutorials/Hardware_Acceleration/Design_Tutorials/07-host-code-opt/reference-files/src/pass.cpp" 2

void read(const ap_int<512> *input,
   hls::stream<ap_int<512> > &inStream,
   unsigned int numInputs) {
  VITIS_LOOP_13_1: for(unsigned int i = 0; i < numInputs; i++) {
#pragma HLS PIPELINE
...
void exec(hls::stream<ap_int<512> > &inStream,
  ...
  VITIS_LOOP_23_1: for(int num = 0; num < numInputs; num++) {
    ap_int<512> in = inStream.read();
    VITIS_LOOP_25_2: for(int i = 0; i < processDelay; i++) {
      in += 1;
    }
    outStream.write(in);
  }
...
void write(hls::stream<ap_int<512> > &outStream,
    ap_int<512> *output,
    unsigned int numInputs) {
  VITIS_LOOP_35_1: for(unsigned int i = 0; i < numInputs; i++) {
#pragma HLS PIPELINE
...
#pragma HLS DATAFLOW
 ...
 (__builtin_assume(static_cast <bool> (numInputs >= 1)));
  (__builtin_assume(static_cast <bool> (processDelay >=1)));
...
extern "C" {
__attribute__((sdx_kernel("pass", 0))) void pass(const ap_int<512> *input,
   ap_int<512> *output,
   unsigned int numInputs,
   unsigned int processDelay) {
#line 23 "/mnt/HLSNAS/02.IZunsR/course-lab_A/Vitis-Tutorials/Hardware_Acceleration/Design_Tutorials/07-host-code-opt/reference-files/_x/pass.hw/pass/pass.tcl"
#pragma HLSDIRECTIVE TOP name=pass
# 64 "/mnt/HLSNAS/02.IZunsR/course-lab_A/Vitis-Tutorials/Hardware_Acceleration/Design_Tutorials/07-host-code-opt/reference-files/src/pass.cpp"
