...
set C_modelArgList {
	{ outStream3 int 512 regular {fifo 0 volatile }  }
	{ p1 int 512 regular {axi_master 1}  }
	{ output_r int 64 regular {fifo 0}  }
	{ numInputs int 32 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "outStream3", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outStream3_dout sc_in sc_lv 512 signal 0 } 
	{ outStream3_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ outStream3_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ outStream3_empty_n sc_in sc_logic 1 signal 0 } 
	{ outStream3_read sc_out sc_logic 1 signal 0 } 
	...
	{ m_axi_p1_AWLEN sc_out sc_lv 32 signal 1 } 
	...
	{ m_axi_p1_ARLEN sc_out sc_lv 32 signal 1 } 
	...
	{ m_axi_p1_RFIFONUM sc_in sc_lv 9 signal 1 } 
	...
	{ output_r_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ output_r_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ output_r_empty_n sc_in sc_logic 1 signal 2 } 
	{ output_r_read sc_out sc_logic 1 signal 2 } 
	{ numInputs_dout sc_in sc_lv 32 signal 3 } 
	{ numInputs_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ numInputs_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ numInputs_empty_n sc_in sc_logic 1 signal 3 } 
	{ numInputs_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outStream3_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "outStream3", "role": "dout" }} , 
 	...
 	{ "name": "outStream3_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outStream3", "role": "empty_n" }} , 
 	{ "name": "outStream3_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outStream3", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "outStream3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_Pipeline_VITIS_LOOP_35_1_fu_73", "Port" : "outStream3", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "p1", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "p1_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "p1_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_Pipeline_VITIS_LOOP_35_1_fu_73", "Port" : "p1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_Pipeline_VITIS_LOOP_35_1_fu_73", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_Pipeline_VITIS_LOOP_35_1_fu_73.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	outStream3 { ap_fifo {  { outStream3_dout fifo_port_we 0 512 }  { outStream3_num_data_valid fifo_status_num_data_valid 0 2 }  { outStream3_fifo_cap fifo_update 0 2 }  { outStream3_empty_n fifo_status 0 1 }  { outStream3_read fifo_data 1 1 } } }
	...
	output_r { ap_fifo {  { output_r_dout fifo_port_we 0 64 }  { output_r_num_data_valid fifo_status_num_data_valid 0 3 }  { output_r_fifo_cap fifo_update 0 3 }  { output_r_empty_n fifo_status 0 1 }  { output_r_read fifo_data 1 1 } } }
